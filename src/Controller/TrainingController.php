...
class TrainingController extends AbstractController
{
    ...
    private function uploadFile(int $trainingId): void
    {
        ...
        // }
        // if (
        //     file_exists($_FILES['url']['tmp_name']) &&
        //     filesize($_FILES['url']['tmp_name']) > $maxFileSize
        // ) {
     ...
     * only when deleting a specific training
     */
    public function deleteParticipant(int $trainingId, int $userId): void
    {
        $trainingUser = new TrainingManager();
        $trainingUser->deleteParticipant((int) $trainingId, (int) $userId);
    }
